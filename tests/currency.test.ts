...
describe("Currency", () => {
  ...
  describe("Conversion methods", () => {
    it("should convert between major and minor units", () => {
      ...
      // Major to minor
      expect(usd.toMinorUnits(10.99)).toBe(10990000n);
      expect(usd.toMinorUnits("10.99")).toBe(10990000n);

      // Minor to major
      expect(usd.toMajorUnits(10990000n)).toBe("10.99");
    });
    ...
    it("should handle currencies with different decimal places", () => {
      ...
      // Major to minor
      expect(jpy.toMinorUnits(1000)).toBe(10000000n);
      expect(bhd.toMinorUnits(1.234)).toBe(12340000n);

      // Minor to major
      expect(jpy.toMajorUnits(10000000n)).toBe("1000");
      expect(bhd.toMajorUnits(12340000n)).toBe("1.234");
    });
  ...
  describe("Custom Currencies", () => {
    ...
    it("should work with Money operations", () => {
      ...
      expect(btc.toMinorUnits("1.12345678")).toBe(1123456780000n);
      expect(btc.toMajorUnits(1123456780000n)).toBe("1.12345678");
    });
